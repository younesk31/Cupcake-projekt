...
-- -----------------------------------------------------
-- Table `cupcake`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cupcake`.`product` (
  `product_id` INT NOT NULL AUTO_INCREMENT,
  `topping_id` INT NOT NULL,
  `bottom_id` INT NOT NULL,
  PRIMARY KEY (`product_id`),
  INDEX `fk_product_toppings1_idx` (`topping_id` ASC) VISIBLE,
  INDEX `fk_product_bottoms1_idx` (`bottom_id` ASC) VISIBLE,
  CONSTRAINT `fk_product_toppings1`
    FOREIGN KEY (`topping_id`)
    REFERENCES `cupcake`.`toppings` (`toppings_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_product_bottoms1`
...
CREATE TABLE IF NOT EXISTS `cupcake`.`orderline` (
  ...
  CONSTRAINT `fk_orders_has_product_product1`
    ...
    REFERENCES `cupcake`.`product` (`product_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
